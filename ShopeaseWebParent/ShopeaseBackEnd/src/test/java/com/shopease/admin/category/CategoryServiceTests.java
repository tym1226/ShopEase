package com.shopease.admin.category;
...
public class CategoryServiceTests {
	...
	public void testCheckUniqueInNewModeReturnDuplicateAlias() {
		...
		assertThat(res).isEqualTo("DuplicatedAlias");
	}	
	...
	@Test
	public void testCheckUniqueInEditwModeReturnDuplicateAlias() {
		Integer id = 1;
		String name = "NameABC";
		String alias = "Computer";
