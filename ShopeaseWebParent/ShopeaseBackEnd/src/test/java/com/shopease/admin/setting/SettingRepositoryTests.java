...
import com.shopease.common.entity.SettingCategory;
...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		// Setting siteName = new Setting("SITE_NAME", "Shopease", SettingCategory.GENERAL);
		Setting siteLogo = new Setting("SITE_LOGO", "Shopease.png", SettingCategory.GENERAL);
		Setting copyright = new Setting("COPYRIGHT", "Copyright (C) 2023 Shopease Ltd.", SettingCategory.GENERAL);
